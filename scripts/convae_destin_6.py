"""
Adding local contrast normalization(LCN) 
Convolution --> LCN --> Pooling
"""
...
def lcn(input_, img_shape, kernel_shape):
  input_= IdentityConvLayer( filter_size=(4,4),
                             num_filters=128,
                             num_channels=1,
                             fm_size=(32,32),
